...
export function UserStatusFilter({ table }: UserStatusFilterProps) {
  ...
  const handleStatusChange = (checked: boolean, value: string) => {
    ...
    table.getColumn("banned")?.setFilterValue(newFilterValue.length ? newFilterValue : undefined);
  };
      ...
      <PopoverContent className="w-auto min-w-48 p-3" align="end">
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="font-medium text-muted-foreground/60 text-xs uppercase">Role</div>

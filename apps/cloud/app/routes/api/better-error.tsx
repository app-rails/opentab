...
import { href, Link, type LoaderFunctionArgs, useSearchParams } from "react-router";
  ...
  return (
    <div className="container mx-auto flex min-h-screen items-center px-6 py-12">
      <div className="mx-auto flex max-w-sm flex-col items-center text-center">
        ...
        <h1 className="mt-2 font-semibold text-xl md:text-2xl">Authentication Error</h1>
        ...
        <div className="mt-6 flex w-full shrink-0 items-center justify-center space-x-3">
          <Link to={href("/auth/sign-in")} className={buttonVariants({ variant: "outline" })}>

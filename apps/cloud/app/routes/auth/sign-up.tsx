...
export default function SignUpRoute() {
  ...
  return (
    ...
    >
      {/* Sign up form */}
      <Form className="grid gap-4" method="POST" context={form.context} {...form.props}>
        <Field>
        ...
        <Field>
          ...
          <PasswordField name="password" placeholder="Enter a unique password" />
          <FieldError
        ...
        <LoadingButton buttonText="Sign Up" loadingText="Signing up..." isPending={isPending} />
      </Form>

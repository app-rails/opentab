...
import { Form as CustomForm, LoadingButton, PasswordField } from "~/components/forms";
...
export default function ResetPasswordRoute({ loaderData: { token } }: Route.ComponentProps) {
  ...
  return (
    ...
    >
      <CustomForm className="grid gap-4" method="POST" context={form.context} {...form.props}>

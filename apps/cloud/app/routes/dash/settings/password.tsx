  ...
  return (
    <SettingsLayout title="Password">
      ...
      <SettingRow
        ...
        description="If you have forgotten your password, you can reset it here. Alternatively, if you have signed up via GitHub, you can set your password here too."
        action={
          <Link
            target="_blank"

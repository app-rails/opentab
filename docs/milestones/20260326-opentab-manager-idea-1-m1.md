...
- [ ] `packages/extension`: WXT 项目初始化 + React + TypeScript
- [ ] `packages/extension`: Tailwind CSS + shadcn/ui 集成
- [ ] `packages/server`: Hono 后端初始化
- [ ] `packages/shared`: 共享类型定义包
- [ ] turborepo pipeline 配置（dev / build / lint）
